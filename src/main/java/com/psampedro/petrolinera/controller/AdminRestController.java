...
class AdminRestController {
    ...
    public AdminRestController(AdminService adminServ) {
    ...
    public ResponseEntity<?> addChargePoint(@RequestBody ChargePointDTO cp) {
        Boolean result = adminServ.addChargePoint(cp);
        return result ? ResponseEntity.notFound().build() : ResponseEntity.ok().build();
    }
